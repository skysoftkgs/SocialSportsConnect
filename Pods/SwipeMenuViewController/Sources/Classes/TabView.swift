    ...
    fileprivate func setupTabItemViews(dataSource: TabViewDataSource) {
        ...
        for index in 0..<itemCount {
            ...
            if let title = dataSource.tabView(self, titleForItemAt: index) {
                ...
                let attrs1 = [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 13), NSAttributedString.Key.foregroundColor : UIColor(red: 253/255, green: 184/255, blue: 10/255, alpha: 1.0)]

                let attrs2 = [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 13), NSAttributedString.Key.foregroundColor : UIColor(red: 160/255, green: 160/255, blue: 160/255, alpha: 1.0)]

                let attributedString1 = NSMutableAttributedString(string:dateArray[0] + "\n", attributes:attrs1)

                let attributedString2 = NSMutableAttributedString(string:dateArray[1], attributes:attrs2)

                attributedString1.append(attributedString2)
                
                tabItemView.titleLabel.attributedText = attributedString1
